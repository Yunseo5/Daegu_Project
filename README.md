...
| 위도 | CCTV 설치 위치 위도 좌표 | 
| 경도 | CCTV 설치 위치 경도 좌표 | 
| 설치목적구분 | CCTV 설치 목적(차량방범, 재난재해, 교통단속 제외) |
...
| 컬럼명 | 설명 | 
|--------|------|
| 위도 | 안전비상벨 설치 위치 위도 좌표 | 
| 경도 | 안전비상벨 설치 위치 경도 좌표 | 
| 설치목적구분 | 안전비상벨 설치 목적 구분 |
...
| 컬럼명 | 설명 |
|--------|------|
| 상권업종소분류명 | 입시.교과학원, 요리주점, 일반 유흥 주점 |
| 위도 | 상가 위치 위도 좌표 | 
| 경도 | 상가 위치 경도 좌표 | 
...
|--------|------|
| 이름 | 초.중.고등학교명 정보 |
| 위도 | 초.중.고등학교 위치 위도 좌표 |
| 경도 | 초.중.고등학교 위치 경도 좌표 |
...
| 컬럼명 | 설명 |
|--------|------|
| 세대수 | 대구광역시 동.읍.면별 세대수 |
| 등록인구(남) | 대구광역시 동.읍.면별 등록인구(남) |
| 등록인구(여) | 대구광역시 동.읍.면별 등록인구(여) |
| 한국인(남) | 대구광역시 동.읍.면별 한국인(남) |
| 한국인(여) | 대구광역시 동.읍.면별 한국인(여) |
| 외국인(남) | 대구광역시 동.읍.면별 외국인(남) |
| 외국인(여) | 대구광역시 동.읍.면별 외국인(여) |
| 세대당 인구 | 대구광역시 동.읍.면별 세대당 인구수 |
| 인구밀도 | 대구광역시 동.읍.면별 인구밀도 |
| 면적(km^2) | 대구광역시 동.읍.면별 면적 |
| 평균연령 | 대구광역시 동.읍.면별 평균연령 |
